...
const donateItem = NAVIGATION.footer.find(
  (item) => item.name === 'Buy me a coffee'
)
  ...
  return (
    <footer className='bg-white'>
      <div className='mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8'>
        <nav
          aria-label='Footer'
          className='-mb-6 flex flex-wrap justify-center gap-x-12 gap-y-3 text-sm/6 min-h-[24px]'
        >
          {NAVIGATION.sidebar
        ...
        <div className='mt-8 flex flex-col md:flex-row gap-4 items-center min-h-[60px] justify-between'>
          <div className='flex justify-center md:justify-start'>
            ...
            >
              ...
              <span className='relative'>{UI_TEXT.buttons.goToTop}</span>
        ...
        <p className='mt-10 text-center text-sm/6 text-gray-600'>
          &copy; 2025 {APP_CONFIG.name}, Inc. All rights reserved.
        </p>
      </div>
    </footer>
  )
