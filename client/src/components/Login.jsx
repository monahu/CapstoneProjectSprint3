        ...
        <div className='mt-10 lg:max-w-[600px] sm:mx-auto sm:w-full sm:max-w-[480px]'>
          <div className='bg-white px-6 py-12 shadow-sm sm:rounded-lg sm:px-12'>
            ...
            >
                  ...
                  <div>
                    ...
                    <div className='mt-2'>
                      <input
                        ...
                        className='block w-full rounded-md px-3 py-1.5 text-base text-gray-900 placeholder:text-gray-400 outline outline-1 outline-gray-300 focus:outline-2 focus:outline-indigo-600 sm:text-sm'
                      />
                    </div>
                  </div>
                  {/* First and Last Name */}
              ...
              <p
                className={`text-red-500 font-bold text-lg ${errorMessage ? 'py-2' : ''}`}
              >
                {errorMessage}
              </p>
